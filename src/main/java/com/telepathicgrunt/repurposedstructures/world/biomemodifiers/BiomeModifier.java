...
public class BiomeModifier {
    public static void addFeatures() {
        ...
        TagKey<Biome> oceanTag = TagKey.create(Registries.BIOME, new ResourceLocation(RepurposedStructuresApi.MODID, "has_structure/dungeons/ocean"));
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_neutral"))
                ...
                context -> context.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_neutral"))));
        ...
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_cold"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> context.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_cold"))));
        ...
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_frozen"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> context.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_frozen"))));
        ...
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_lukewarm"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> context.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_lukewarm"))));
        ...
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_warm"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> context.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, "dungeons/ocean_warm"))));
    }
    ...
    private static void addToBiome(String featureName, GenerationStep.Decoration step) {
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, featureName))
                .add(ModificationPhase.ADDITIONS,
                        (context) -> context.hasTag(TagKey.create(Registries.BIOME, new ResourceLocation(RepurposedStructuresApi.MODID, "has_structure/" + featureName))),
                        (context) -> context.getGenerationSettings().addFeature(step, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RepurposedStructuresApi.MODID, featureName))));
    }
    ...
    private static void removeFromBiome(ResourceLocation feature, String biomeTagName, GenerationStep.Decoration step) {
        BiomeModifications.create(new ResourceLocation(RepurposedStructuresApi.MODID, "remove_" + feature.getPath()))
                .add(ModificationPhase.REMOVALS,
                        (context) -> context.hasTag(TagKey.create(Registries.BIOME, new ResourceLocation(RepurposedStructuresApi.MODID, biomeTagName))),
