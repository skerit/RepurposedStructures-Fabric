...
public class RepurposedStructuresApi implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ResourceManagerHelper.get(PackType.SERVER_DATA).registerReloadListener(RepurposedStructuresApi.mobSpawnerManager);
        ResourceManagerHelper.get(PackType.SERVER_DATA).registerReloadListener(RepurposedStructuresApi.structureMapManager);
        ResourceManagerHelper.get(PackType.SERVER_DATA).registerReloadListener(RepurposedStructuresApi.structurePieceCountsManager);

        // Controls the dimension blacklisting
        // Must run after fapi to undo its changes
        ResourceLocation runAfterFabricAPIPhase = new ResourceLocation(RepurposedStructuresApi.MODID, "run_after_fabric_api");
