...
public class EndRemasteredDedicatedLoot {
    ...
    private static Map<ResourceLocation, ResourceLocation> createEndRemasteredMap() {
        ...
        tableMap.put(new ResourceLocation(RepurposedStructuresApi.MODID, "chests/outposts/mangrove"), new ResourceLocation("endrem:minecraft/chests/pillager_outpost"));
