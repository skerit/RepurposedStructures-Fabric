...
public final class JSONConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> RS_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(new ResourceLocation(RepurposedStructuresApi.MODID, "json_conditions"));
    ...
    public static void createJSONConditionsRegistry() {
        ...
        BuiltInRegistries.REGISTRY.getOptional(new ResourceLocation(RepurposedStructuresApi.MODID, "json_conditions"))
            .ifPresent(registry -> Registry.register(
                (Registry<Supplier<Boolean>>)registry,
                new ResourceLocation(RepurposedStructuresApi.MODID, "test"),
                () -> false));
    }
}
