...
public final class RSStructurePlacementType {
    ...
    public static void registerStructurePlacementTypes() {
        Registry.register(BuiltInRegistries.STRUCTURE_PLACEMENT, new ResourceLocation(RepurposedStructuresApi.MODID, "advanced_random_spread"), ADVANCED_RANDOM_SPREAD);
    }
}
