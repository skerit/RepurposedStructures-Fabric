...
public final class RSPredicates {
    ...
    public static void registerPredicates() {
        Registry.register(Registry.RULE_TEST, new ResourceLocation(RepurposedStructuresApi.MODID, "matter_phase_rule_test"), MATTER_PHASE_RULE_TEST);

        Registry.register(Registry.POS_RULE_TEST, new ResourceLocation(RepurposedStructuresApi.MODID, "piece_origin_axis_aligned_linear_pos_rule_test"), PIECE_ORIGIN_AXIS_ALIGNED_LINEAR_POS_RULE_TEST);
        Registry.register(Registry.POS_RULE_TEST, new ResourceLocation(RepurposedStructuresApi.MODID, "y_value_pos_rule_test"), Y_VALUE_POS_RULE_TEST);
    }
}
